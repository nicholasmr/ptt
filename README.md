...
***What can it do?*** 🧊
- Model travel times along oblique ray paths using a Maxwell–Garnett effective medium formulation coupled to a single stage Herron–Langway density model with a power-law bubble eccentricity profile.
